...
## Project Structure
    ...
    ├── testapiautocatalog_125504  # Django project configurations
...
1. Clone this repo and `cd testapiautocatalog_125504`
...
2. Clone this repo and `cd testapiautocatalog_125504`
